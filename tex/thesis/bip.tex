...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
We recall the necessary concepts of the BIP framework~\cite{BasuBBCJNS11}.
...
the traffic light. Additionally, it % and at the end of each light cycle, 
informs the timer about the amount of time to spend in each 
location through a data transfer on the interaction between the two components. 
\begin{figure}
\centering
\resizebox{0.6\textwidth}{!}{
  \input{figures/traffic.pdftex_t}
}
\caption{Traffic light controller BIP system}
