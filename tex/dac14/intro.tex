...
SystemC\cite{systemc} in turn is a modeling framework based on C++ that allows
...
by embedding the execution model of the embedded system in the systems it generates
for each concern. 
This allows for simple debugging and design flow cycle iterations. Furthermore, 
the user of AIG circuits for synthesis and model checking allows our method to leverage
