...
\item The method translates the \caig program into a concurrent runtime verification 
  ...
  aligned with automated test case generation techniques. 

\end{enumerate}

Our results show that \biptool{} verifies large systems that are not possible with existing techniques. 
