...
\biptool{} (BIP Synthesis Verification) is a Java implementation of the translation from BIP to $\caig$ described in Section \ref{sec:bip2aig}, and, is part of the BIP distribution~\cite{verimagbiponline}.
