...
In addition,
our translation takes a high level model directly into a bit-level circuit
by embedding built-in scheduling into the design. 
This allows for avoiding use of compilers to interpret models in Verilog.
of BLIF. 
which avoids the need for other compilers and 

Aside from the differences between Esterel and BIP, 
our translation takes a BIP model TODO Fadi
}
