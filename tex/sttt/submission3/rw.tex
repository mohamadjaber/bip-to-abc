...
\caig and all 
other elements such as interaction and port enablement elements 
are encoded using wires. 
The NuSMV translation uses registers for all BIP elements. 
Thus, implying a larger state space. 
Performing the same encoding in NuSMV requires using redundant 
...
\item 
 ...
 Performing the same with the NuSMV implementation requires developing 
