...
\redbox{Moreover, \biptool{} takes as input a property to be verified expressed by pre and post conditions over atomic propositions. Atomic propositions are conditions on components (e.g., a condition on the lastly-executed port, current locations of atomic components, values of variables). The pre and post conditions are stored in a file to be parsed by \biptool{}. 
