...
%
The overhead may drastically increase when 
...
In our case, it is possible to add a circuit that identifies and enables all non-conflicting interactions with a simple modification
that merges the consecutive execution cycles of non-conflicting interactions into one cycle.
Such transformation is available for free with the retiming algorithm 
