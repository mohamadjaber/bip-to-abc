  ...
  wire_selector = rand() % 34;
{
    ...
    interactions_first_enable[19] = ((true && wire_port_loc_en_plugC1_SendS1) && wire_port_loc_en_serverC1_rcvPlugC);
    ...
    interactions_first_enable[25] = ((true && wire_port_loc_en_plugC1_sendClient) && wire_port_loc_en_plug1_recieveFromServer);
    interactions_first_enable[31] = (((var_serverC2_clientIdSend == var_plugC1_clientId) && wire_port_loc_en_serverC2_sendPlug) && wire_port_loc_en_plugC1_rcvServer);
    interactions_first_enable[29] = ((true && wire_port_loc_en_serverC2_sendServer) && wire_port_loc_en_s2_RcvFromChannel);
    ...
    interactions_first_enable[20] = ((true && wire_port_loc_en_serverC2_rcvPlugC) && wire_port_loc_en_plugC1_SendS2);
    ...
    interactions_first_enable[23] = (((var_serverC1_clientIdSend == var_plugC1_clientId) && wire_port_loc_en_plugC1_rcvServer) && wire_port_loc_en_serverC1_sendPlug);
    interactions_first_enable[30] = ((true && wire_port_loc_en_serverC2_rcvServer) && wire_port_loc_en_s2_SendToServerC);
    ...
    interactions_first_enable[18] = ((true && wire_port_loc_en_plugC1_rcvPlug) && wire_port_loc_en_plug1_sendToChannel);
