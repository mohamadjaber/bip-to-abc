...
wire boolean  interactions_enablement[54];
wire boolean  interactions_first_enable[54];
  ...
  wire_selector = rand() % 54;
{
    ...
    interactions_first_enable[44] = ((true && wire_port_loc_en_serverC2_rcvPlugC) && wire_port_loc_en_plugC3_SendS2);
    interactions_first_enable[14] = (true && wire_port_loc_en_serverC2_loose);
    interactions_first_enable[47] = ((true && wire_port_loc_en_plug3_recieveFromServer) && wire_port_loc_en_plugC3_sendClient);
    interactions_first_enable[19] = (true && wire_port_loc_en_plug4_singleton1);
    interactions_first_enable[34] = ((true && wire_port_loc_en_plug2_sendToChannel) && wire_port_loc_en_plugC2_rcvPlug);
    interactions_first_enable[11] = (true && wire_port_loc_en_plug4_ticker);
    interactions_first_enable[45] = (((var_serverC1_clientIdSend == var_plugC3_clientId) && wire_port_loc_en_serverC1_sendPlug) && wire_port_loc_en_plugC3_rcvServer);
    ...
    interactions_first_enable[41] = ((true && wire_port_loc_en_plug2_recieveFromServer) && wire_port_loc_en_plugC2_sendClient);
    ...
    interactions_first_enable[37] = ((true && wire_port_loc_en_serverC2_sendServer) && wire_port_loc_en_s2_RcvFromChannel);
    ...
    interactions_first_enable[26] = ((true && wire_port_loc_en_plugC1_rcvPlug) && wire_port_loc_en_plug1_sendToChannel);
    interactions_first_enable[40] = (((var_serverC2_clientIdSend == var_plugC2_clientId) && wire_port_loc_en_serverC2_sendPlug) && wire_port_loc_en_plugC2_rcvServer);
    ...
    interactions_first_enable[46] = (((var_serverC1_clientIdSend == var_plugC4_clientId) && wire_port_loc_en_plugC4_rcvServer) && wire_port_loc_en_serverC1_sendPlug);
    ...
    interactions_first_enable[36] = ((true && wire_port_loc_en_serverC2_rcvPlugC) && wire_port_loc_en_plugC2_SendS2);
    interactions_first_enable[51] = (((var_serverC2_clientIdSend == var_plugC3_clientId) && wire_port_loc_en_serverC2_sendPlug) && wire_port_loc_en_plugC3_rcvServer);
    ...
    interactions_first_enable[53] = ((true && wire_port_loc_en_plugC4_sendClient) && wire_port_loc_en_plug4_recieveFromServer);
    interactions_first_enable[48] = ((true && wire_port_loc_en_plugC4_rcvPlug) && wire_port_loc_en_plug4_sendToChannel);
    interactions_first_enable[52] = (((var_serverC2_clientIdSend == var_plugC4_clientId) && wire_port_loc_en_plugC4_rcvServer) && wire_port_loc_en_serverC2_sendPlug);
    interactions_first_enable[29] = ((true && wire_port_loc_en_serverC1_sendServer) && wire_port_loc_en_s1_RcvFromChannel);
    ...
    interactions_enablement[47] = (interactions_first_enable[47] && ((wire_selector == 47) || (( ! interactions_first_enable[wire_selector])  && ((((((true && ( ! interactions_first_enable[48]) ) && ( ! interactions_first_enable[49]) ) && ( ! interactions_first_enable[50]) ) && ( ! interactions_first_enable[51]) ) && ( ! interactions_first_enable[52]) ) && ( ! interactions_first_enable[53]) ))));
    interactions_enablement[48] = (interactions_first_enable[48] && ((wire_selector == 48) || (( ! interactions_first_enable[wire_selector])  && (((((true && ( ! interactions_first_enable[49]) ) && ( ! interactions_first_enable[50]) ) && ( ! interactions_first_enable[51]) ) && ( ! interactions_first_enable[52]) ) && ( ! interactions_first_enable[53]) ))));
    interactions_enablement[49] = (interactions_first_enable[49] && ((wire_selector == 49) || (( ! interactions_first_enable[wire_selector])  && ((((true && ( ! interactions_first_enable[50]) ) && ( ! interactions_first_enable[51]) ) && ( ! interactions_first_enable[52]) ) && ( ! interactions_first_enable[53]) ))));
    interactions_enablement[50] = (interactions_first_enable[50] && ((wire_selector == 50) || (( ! interactions_first_enable[wire_selector])  && (((true && ( ! interactions_first_enable[51]) ) && ( ! interactions_first_enable[52]) ) && ( ! interactions_first_enable[53]) ))));
    interactions_enablement[51] = (interactions_first_enable[51] && ((wire_selector == 51) || (( ! interactions_first_enable[wire_selector])  && ((true && ( ! interactions_first_enable[52]) ) && ( ! interactions_first_enable[53]) ))));
    interactions_enablement[52] = (interactions_first_enable[52] && ((wire_selector == 52) || (( ! interactions_first_enable[wire_selector])  && (true && ( ! interactions_first_enable[53]) ))));
    interactions_enablement[53] = (interactions_first_enable[53] && ((wire_selector == 53) || (( ! interactions_first_enable[wire_selector])  && true)));
    wire_port_en_plug1_singleton1 = (false || interactions_enablement[16]);
    wire_port_en_plug1_recieveFromServer = (false || interactions_enablement[33]);
    ...
    wire_port_en_plug1_sendToChannel = (false || interactions_enablement[26]);
    wire_port_en_plug2_singleton1 = (false || interactions_enablement[17]);
    wire_port_en_plug2_recieveFromServer = (false || interactions_enablement[41]);
    ...
    wire_port_en_plug2_sendToChannel = (false || interactions_enablement[34]);
    wire_port_en_plug3_singleton1 = (false || interactions_enablement[18]);
    wire_port_en_plug3_recieveFromServer = (false || interactions_enablement[47]);
    ...
    wire_port_en_plug3_sendToChannel = (false || interactions_enablement[42]);
    wire_port_en_plug4_singleton1 = (false || interactions_enablement[19]);
    wire_port_en_plug4_recieveFromServer = (false || interactions_enablement[53]);
    ...
    wire_port_en_plug4_sendToChannel = (false || interactions_enablement[48]);
    wire_port_en_plugC1_rcvPlug = (false || interactions_enablement[26]);
    wire_port_en_plugC1_SendS1 = (false || interactions_enablement[27]);
    wire_port_en_plugC1_sendClient = (false || interactions_enablement[33]);
    wire_port_en_plugC1_SendS2 = (false || interactions_enablement[28]);
    wire_port_en_plugC1_rcvServer = ((false || interactions_enablement[31]) || interactions_enablement[39]);
    wire_port_en_plugC2_rcvPlug = (false || interactions_enablement[34]);
    wire_port_en_plugC2_SendS1 = (false || interactions_enablement[35]);
    wire_port_en_plugC2_sendClient = (false || interactions_enablement[41]);
    wire_port_en_plugC2_SendS2 = (false || interactions_enablement[36]);
    wire_port_en_plugC2_rcvServer = ((false || interactions_enablement[32]) || interactions_enablement[40]);
    wire_port_en_plugC3_rcvPlug = (false || interactions_enablement[42]);
    wire_port_en_plugC3_SendS1 = (false || interactions_enablement[43]);
    wire_port_en_plugC3_sendClient = (false || interactions_enablement[47]);
    wire_port_en_plugC3_SendS2 = (false || interactions_enablement[44]);
    wire_port_en_plugC3_rcvServer = ((false || interactions_enablement[45]) || interactions_enablement[51]);
    wire_port_en_plugC4_rcvPlug = (false || interactions_enablement[48]);
    wire_port_en_plugC4_SendS1 = (false || interactions_enablement[49]);
    wire_port_en_plugC4_sendClient = (false || interactions_enablement[53]);
    wire_port_en_plugC4_SendS2 = (false || interactions_enablement[50]);
    wire_port_en_plugC4_rcvServer = ((false || interactions_enablement[46]) || interactions_enablement[52]);
    ...
    wire_port_en_serverC1_rcvPlugC = ((((false || interactions_enablement[27]) || interactions_enablement[35]) || interactions_enablement[43]) || interactions_enablement[49]);
    wire_port_en_serverC1_sendServer = (false || interactions_enablement[29]);
    wire_port_en_serverC1_sendPlug = ((((false || interactions_enablement[31]) || interactions_enablement[32]) || interactions_enablement[45]) || interactions_enablement[46]);
    wire_port_en_serverC1_rcvServer = (false || interactions_enablement[30]);
    ...
    wire_port_en_serverC2_rcvPlugC = ((((false || interactions_enablement[28]) || interactions_enablement[36]) || interactions_enablement[44]) || interactions_enablement[50]);
    wire_port_en_serverC2_sendServer = (false || interactions_enablement[37]);
    wire_port_en_serverC2_sendPlug = ((((false || interactions_enablement[39]) || interactions_enablement[40]) || interactions_enablement[51]) || interactions_enablement[52]);
    wire_port_en_serverC2_rcvServer = (false || interactions_enablement[38]);
    wire_port_en_s1_SendToServerC = (false || interactions_enablement[30]);
    wire_port_en_s1_RcvFromChannel = (false || interactions_enablement[29]);
    wire_port_en_s1_singleton1 = (false || interactions_enablement[24]);
    wire_port_en_s2_SendToServerC = (false || interactions_enablement[38]);
    wire_port_en_s2_RcvFromChannel = (false || interactions_enablement[37]);
