  ...
  wire_selector = __interactionsArray__[__cycle_num__];
{
    ...
    interactions_first_enable[18] = ((true && wire_port_loc_en_plugC1_SendS2) && wire_port_loc_en_serverC2_rcvPlugC);
    ...
    interactions_first_enable[29] = (((var_serverC2_clientIdSend == var_plugC1_clientId) && wire_port_loc_en_plugC1_rcvServer) && wire_port_loc_en_serverC2_sendPlug);
