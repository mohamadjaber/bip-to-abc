  ...
  wire_selector = __interactionsArray__[__cycle_num__];
{
    ...
    interactions_first_enable[27] = ((true && wire_port_loc_en_s2_RcvFromChannel) && wire_port_loc_en_serverC2_sendServer);
    ...
    interactions_first_enable[30] = (((var_serverC2_clientIdSend == var_plugC2_clientId) && wire_port_loc_en_plugC2_rcvServer) && wire_port_loc_en_serverC2_sendPlug);
    ...
    interactions_first_enable[19] = ((true && wire_port_loc_en_s1_RcvFromChannel) && wire_port_loc_en_serverC1_sendServer);
    ...
    interactions_first_enable[20] = ((true && wire_port_loc_en_s1_SendToServerC) && wire_port_loc_en_serverC1_rcvServer);
    ...
    interactions_first_enable[26] = ((true && wire_port_loc_en_plugC2_SendS2) && wire_port_loc_en_serverC2_rcvPlugC);
    interactions_first_enable[16] = ((true && wire_port_loc_en_plug1_sendToChannel) && wire_port_loc_en_plugC1_rcvPlug);
    ...
    interactions_first_enable[28] = ((true && wire_port_loc_en_s2_SendToServerC) && wire_port_loc_en_serverC2_rcvServer);
    interactions_first_enable[15] = (true && wire_port_loc_en_plug2_singleton2);
    interactions_first_enable[22] = (((var_serverC1_clientIdSend == var_plugC2_clientId) && wire_port_loc_en_serverC1_sendPlug) && wire_port_loc_en_plugC2_rcvServer);
