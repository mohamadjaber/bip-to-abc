  ...
  wire_selector = rand() % 32;
{
    ...
    interactions_first_enable[31] = ((true && wire_port_loc_en_plug2_recieveFromServer) && wire_port_loc_en_plugC2_sendClient);
    ...
    interactions_first_enable[24] = ((true && wire_port_loc_en_plug2_sendToChannel) && wire_port_loc_en_plugC2_rcvPlug);
