	...
	public static void main(String[] args) {
		...
		if(cmdLen < 2) {
			...
			try {
				...
				if(ct != null) {
					if(optimized) 
					 tCompound = new TCompoundOneCycle(ct, false, null, null);
					else 
						 tCompound = new TCompoundTwoCycle(ct, false, null, null);
