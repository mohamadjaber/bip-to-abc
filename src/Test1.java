...
public class Test1 {
	public static void main(String[] args) throws FileNotFoundException {
		...
		CompoundType ct = TransformationFunction.ParseBIPFile("/home/jaberm/work/bipExamples/abc/quorumDeadlock.bip");
		TCompound tCompound = new TCompoundOneCycle(ct);
		
		
		new TGenerator(tCompound, "output/quorumDeadlock.abc");
	}
}
